// V1.5.4 vom 16.6.2020 - https://github.com/Pittini/iobroker-Fensterauswertung - https://forum.iobroker.net/topic/31674/vorlage-generisches-fensteroffenskript-vis
    ...
    if (Funktion == undefined) {
        ...
        if (Funktion == WelcheFunktionVerwenden) { //Wenn Function ist Verschluss
            for (let y in members) { // Loop über alle Verschluss Members
                ...
                if (logging) log("Sensor["+y+"] "+Sensor[y]+" gehört zu Raum "+room);
                if (typeof room == 'object') room = room.de;
                if (typeof room == 'undefined') room = "Raum undefiniert";
